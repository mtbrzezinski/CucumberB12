...
#    Given User navigates to the WebOrder
#    When User provides correct 'guest1@microworks.com' and wrong 'zhmed' for WebOrder
...
#    Given User navigates to the WebOrder
#    When User provides wrong 'ahmed@gmail.com' and correct 'Guest1!' for WebOrder
#    Then User validates the 'Sign in Failed' error message
#
#  Scenario: Validation of WebOrder Login Scenario(empty username and password)
#    Given User navigates to the WebOrder
